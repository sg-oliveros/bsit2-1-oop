...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(book.getTitle() + " - " + " " + daysLateBook +" days late: $"+ book.calculateLateFee(daysLateBook));

        double feeDVD = dvd.calculateLateFee(daysLateDVD);
        System.out.println(dvd.getTitle() + " - " + " " +  daysLateDVD +" days late: $"+ dvd.calculateLateFee(daysLateDVD));

        System.out.println("\n== Testing User Information ==");

        System.out.println("Student: "+ studentJohn.getName() + "(" + studentJohn.getMajor() +")" + studentJohn.getBorrowedItemsCount());


        System.out.println("Faculty: " +  facultySmith.getName()+ "( " +  facultySmith.getDepartment()  +" )" +   facultySmith.getBorrowedItemsCount());
    }
}